...
\fbox{\includegraphics[scale=0.35]{pic.jpg}}
\end{figure}
...
\fbox{\includegraphics[width=7.5cm,height=5cm]{pic.jpg}}
\end{figure}
\end{minipage} \hfill
...
wider? A lot of it will be clear when you read up on the knitting patterns class. It is already available with the MacTeX distributions, and of course, online on Overleaf. If your distribution does not offer it, download it from here and copy the .cls file to the folder/directory your code is in. See the point where stuff becomes exponentially harder to do without LATEX? We daresay the rest of this assignment crosses that point. Good luck!
...
London, 1851\\https://www.overleaf.com/project/63121f5c8b88bb4e411b0358
\newchessgame
...
\end{tikzpicture}
\end{center}
If you recall JEE Physics, this is a circuit diagram of a npn transistor used as an amplifier. Try your best to match  this circuit. We have used the American voltages convention. It is alright if you can't get the dimensions to match. What is important is that you know how to use circuitiz to draw circuits with the components used above and mark voltages,and currents. 

\section{Typesetting exam}
Congratulations, you're appointed as a TA for the course you loved last year. The prof,however is busy with his research, and wants you to typeset an exam. LATEX, with its exam class can help you do just that!

You'll need to make a separate document,if you want attempt this task. Your job is to imitate the exam.pdf that we have provided.

\newpage
\noindent\textbox{Maths\hfill}\textbox{\hfill
Assignment\hfill}\textbox{\hfill IIITB \#}
\hline
\vspace{1cm}
\begin{flushleft}
\textbf{Problem 1.}
Show that there exists no nontrivial unramified extensions of  $\mathbb{Q}$ .\\
\vspace{1cm}
...
\draw (0,0) -- (2,2);
\draw (2,0) -- (0,2);
\draw (2.2,0) -- (2.2,2) --(4.2 ,2) -- (4.2,0)--(2.2,0) -- (4.2,2)  ;
\draw (4.2,0)-- (2.2,2);
